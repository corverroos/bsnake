...
if [ "$1" == "solo" ]; then
  ...
  battlesnake play -W 11 -H 11 --name M2 --url http://localhost:8080/mx2/ --name M4 --url http://localhost:8080/mx4/ -g royale -v
elif [ "$1" == "dual" ]; then
  battlesnake play -W 11 -H 11 --name V5 --url http://localhost:8080/v5/ --name V3 --url http://localhost:8080/v3/ -g standard -v
elif [ "$1" == "trip" ]; then
